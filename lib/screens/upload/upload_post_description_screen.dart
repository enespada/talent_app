...
class _UploadPostDescriptionScreenState
  ...
  void showDialogCustom(BuildContext context, {required String text}) {
    showDialog(
      context: context,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      cursorColor: AppColors.mediunLightGrey,
                      ...
                      validator: (text) {
                        if (text == null || text.isEmpty)
                          return Localization.of(context)
                              .string('upload_challenge_description_error');
                        return null;
                      },
                    ),
                    ...
                    //       return _Ubication(nombre: _ubicaciones[index]);
                    //     },
                    //   ),
                    // ),
                    Wrap(
        ...
        // child: UploadDescriptionTemplate(
        //   title: Localization.of(context).string('upload_new_post'),
        //   action: GestureDetector(
        //     onTap: () async {
        //       await uploadPost(userService, postsService);
